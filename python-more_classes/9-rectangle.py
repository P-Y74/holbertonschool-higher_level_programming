...
class Rectangle:
    ...
    def square(cls, size=0):
        ...
        This class method returns a new instance of Rectangle where the
        width and height are equal to the provided size value.

        Args:
            size (int): The size of both the width and the height
            of the square.
